function() {
    ...
    function runInContext(context, exports) {
        ...
        var isExtended = new Date(-3.50982733457329E+15);
        try {
            ...
            if (name == "bug-string-char-index") {
                ...
                if (name == "json") {
                    ...
                    if (name == "json-stringify") {
                        ...
                        var stringifySupported = typeof stringify == "function" && isExtended;
                        if (stringifySupported) {
                            ...
                            try {
                                ...
                                }) == serialized && stringify(null, value) === "1" && stringify([1, 2], null, 1) == "[\n 1,\n 2\n]" && stringify(new Date(-8.64E+15)) == "\"-271821-04-20T00:00:00.000Z\"" && stringify(new Date(8.64E+15)) == "\"+275760-09-13T00:00:00.000Z\"" && stringify(new Date(-62198755200000)) == "\"-000001-01-01T00:00:00.000Z\"" && stringify(new Date(-1)) == "\"1969-12-31T23:59:59.999Z\"";
                            } catch (exception) {
                ...
                isProperty = function(property) {
                    ...
                    if (members.__proto__ = null, members.__proto__ = {
                        ...
                        isProperty = function(property) {
                            ...
                            var result = property in this.__proto__ = null,
                                this;
                ...
                var serialize = function(property, object, callback, properties, whitespace, indentation, stack) {
                    ...
                    if (typeof value == "object" && value) {
                        ...
                        if (className == dateClass && !isProperty.call(value, "toJSON")) {
                            ...
                            if (typeof value.toJSON == "function" && className != numberClass && className != stringClass && className != arrayClass || isProperty.call(value, "toJSON")) {
                    ...
                    if (objectTypes[typeof filter] && filter) {
                        if (className = getClass.call(filter) == functionClass) {
                            ...
                            if (className == arrayClass) {
                                properties = {};
                                for (var index = 0,
                                var length = filter.length, value; index < length; value = filter[index++], className = getClass.call(value), className == stringClass || className == numberClass && properties[value] = 1) {
                ...
                var lex = function() {
                    ...
                    while (Index < length) {
                        ...
                        switch (charCode) {
                            ...
                            case 58:
                            case 44:
                                value = charIndexBuggy ? source.charAt(Index):
                                    source[Index];
                                    Index++;
                                    return value;
                                case 34:
